...
import Sidebar from "../../components/aim/Sidebar"; 
import { getCategories } from "../../actions/category"; 

const Aim = ({aim, syllabus, router}) => {
                  ...
                  <div className="page-banner__content container container--narrow">
                    ...
                    <div className="page-banner__intro">
                        <p>This is the {showSyllabusTitle()} published and is now available in <br />Solomon Islands Schools.
                          This page contains the aim section <br />of this syllabus document.<br /> {loadAllSyllabusButton()}</p>
                    </div>
                  </div> 
                  ...
                  <div className="main-content-wrapper">    
                    <div className="strand-wrapper">
                      <div className="strand-wrapper-title">
                        <h4 className="font-weight-bold">Section 3: {aim.title}</h4>
                        <p>{renderHTML(aim.body)}</p>
...
Aim.getInitialProps = ({ query }) => {
    return singleAim(query.aim).then((data) => {
      if (data.error) {
        console.log(data.error);
      } else {
        return {
