          ...
          <div>
            <header>
              <div>
                  ...
                  <Jumbotron>
                  <div style={{marginTop: "60px"}}><h3 className="text-center font-weight-bold">Manage Primary Syllabus Dashboard</h3></div>
                  <div className="text-center">
                    <p className="lead">
                      This page contains all the forms to create the content of any Solomon Islands primary syllabus.<br />
