...
const RationaleSideBar = ({ syllabus }) => {
  ...
  const Rationale = () => {
    return syllabus.map((s, i) => {
      return(
        <div key={i}>
          {
            s.rationale.map((ration, i) => {
              return(
                <Link href="/rationale/[rationale]" as={`/rationale/${ration.rationale}`}>
                  <a style={{color: "black"}}>
                    <strong>Section 2:</strong> {ration.title} 
                  </a>
                </Link>
              )
            })
        ...
        <div key={i}>
          {
            s.aim.map((a, i) => {
              return(
                <Link href="/aim/[aim]" as={`/aim/${a.aim}`}>
                  <a style={{color: "black"}}>
                    <strong>Section 3:</strong> {a.title} 
                  </a>
                </Link>
              )
            })
...
export default RationaleSideBar;
